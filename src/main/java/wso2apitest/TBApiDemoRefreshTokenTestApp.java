...
public class TBApiDemoRefreshTokenTestApp {
	private final Logger logger = Logger.getLogger(TBApiDemoRefreshTokenTestApp.class.getName());
	...
	public static void main(String[] args) throws ApiException {
		TBApiDemoRefreshTokenTestApp app=new TBApiDemoRefreshTokenTestApp();
		//1、获取缺省ApiClient
	    ...
	    while(true){
	    	try{
			    ...
			    if (result.getHasNext())
			    	...
			    	idOffset = null;
			    //7、输出资产查询结果
			    System.out.println("第 " + i + " 次查询，结果：" + result.getData().size());
